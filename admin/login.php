          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <form class="row g-3 needs-validation" novalidate id="login-frm">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">MR./Ms.</span>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a
                          href="https://ritik-portfolio-theta.vercel.app/">Create an account</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Made by <a href="https://ritik-portfolio-theta.vercel.app/" target="_blank"> <strong>Ritikk ❤️
                  </strong></a>
              </div>
