<!-- Navbar -->
  ...
  <a href="<?php echo base_url ?>index3.html" class="navbar-brand"> 
     ...
     <!--<img src="<?php echo base_url ?>assets/img/My_Logo.png?v=<?php echo time(); ?>" 
     alt="My Logo" 
     class="brand-image img-circle elevation-3" 
     style="opacity: .8">-->

     
       <img src="<?php echo base_url ?>assets/img/My_Logo.png" alt="My Logo" class="brand-image img-circle elevation-3" style="opacity: .8">

        <span class="brand-text font-weight-light">STFS</span>
      </a>
