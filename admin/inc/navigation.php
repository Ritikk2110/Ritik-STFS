...
<!--             script for Welcmome  Transition                 -->
<script>
  setTimeout(function() {
    ...
    if (msg) {
      ...
      msg.style.opacity = "0";
      setTimeout(() => msg.style.display = "none", 4000); // wait for fade out
    }
  }, 9000);
</script>
...
<div id="welcome-msg" style="color: #012970; font-weight: bold; font-size:30px">
  <?php
  echo "Welcome, " . ($_settings->userdata('firstname') ?? $_settings->userdata('entered_name') ?? 'Admin') . "!";
  ?>
</div>
  ...
  <li class="nav-heading"> <strong>Maintenance</strong></li>
