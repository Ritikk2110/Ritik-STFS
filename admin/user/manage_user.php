...
<div class="card card-outline rounded-0 card-navy">
		...
		<div class="container-fluid pt-4">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<input type="password" name="password" id="password" class="form-control" value="" autocomplete="current-password">
                ...
                <div class="form-group">
					...
					<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Demo</option>
                    </select>
                </div>
				<div class="form-group">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary bg-gradient-teal border-0 rounded-0 mr-3" form="manage-user">Save  Details</button>
